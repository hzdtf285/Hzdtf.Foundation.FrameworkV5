...
namespace Hzdtf.BasicFunction.Service.Impl.Expand.User
{
    ...
    public class UserValiService : IUserVali<int, BasicUserInfo<int>>
    {
        ...
        public virtual ReturnInfo<BasicUserInfo<int>> Vali([DisplayName2("用户"), Required] string user, [DisplayName2("密码"), Required] string password, CommonUseData comData = null)
        {
            ReturnInfo<BasicUserInfo<int>> returnInfo = new ReturnInfo<BasicUserInfo<int>>();
            var re = ProtoUserVali.Vali(user, password, comData);
